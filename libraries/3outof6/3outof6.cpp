...
void Mbus3outof6Class::encode3outof6 (uint8 *uncodedData, uint8 *encodedData, uint8 lastByte)
{
  
// Table for encoding for a 4-bit data into 6-bit 
// "3 out of 6" coded data.
  const uint8 encodeTab[16] = {0x16,  // 0x0 "3 out of 6" encoded 
...
uint8 Mbus3outof6Class::decode3outof6(uint8 *encodedData, uint8 *decodedData, uint8 lastByte)
{
  
// Table for decoding a 6-bit "3 out of 6" encoded data into 4-bit 
// data. The value 0xFF indicates invalid "3 out of 6" coding
const uint8 decodeTab[64] = {0xFF, //  "3 out of 6" encoded 0x00 decoded
