...
void MbusManchClass::manchEncode(uint8 *uncodedData, uint8 *encodedData)
{
	// Table for encoding 4-bit data into a 8-bit Manchester encoding.
	const uint8 manchEncodeTab[16] = {0xAA,  // 0x0 Manchester encoded 
...
uint8 MbusManchClass::manchDecode(uint8 *encodedData, uint8 *decodedData)
{
	// Table for decoding 4-bit Manchester encoded data into 2-bit 
	// data. 0xFF indicates invalid Manchester encoding
	const uint8 manchDecodeTab[16] = {0xFF, //  Manchester encoded 0x0 decoded
