...
////////////////////////////////////////////////////////////////////////
fs_status_t
FsClass::init(fs_t *fs, df_chip_t chip, uint8_t force)
{
  fs->chip = chip;
  fs->lastpage = 0xffff;
  fs->flags = 0;
...
////////////////////////////////////////////////////////////////////////
fs_status_t
FsClass::create(fs_t *fs, char *name)
{
...
fs_status_t
FsClass::rename(fs_t *fs, char *from, char *to)
{
  if(*to)
    remove(fs, to);
  if(get_inode(fs, from) == 0xffff)
...
////////////////////////////////////////////////////////////////////////
fs_status_t
FsClass::remove(fs_t *fs, char *name)
{
  return rename(fs, name, "");
}


////////////////////////////////////////////////////////////////////////
fs_status_t
FsClass::list(fs_t *fs, char *dir, char *buf, fs_index_t index)
{
  fs->last_inode_index = 0;
  for(uint16_t off = 0; off < QFS_MAGIC_OFFSET; off += sizeof(inode_t)) {
...
////////////////////////////////////////////////////////////////////////
fs_inode_t
FsClass::get_inode(fs_t *fs, char *file)
{
...
////////////////////////////////////////////////////////////////////////
void
FsClass::cache_last_inode(fs_t *fs, fs_inode_t inode)
{
...
////////////////////////////////////////////////////////////////////////
void
FsClass::cache_page(fs_t *fs, uint16_t page, uint8_t doload)
{
  if(fs->lastpage == page)
    return;
...
uint16_t
FsClass::offset2page(uint16_t inode, uint16_t offset)
{
...
////////////////////////////////////////////////////////////////////////
fs_size_t
FsClass::read(fs_t *fs, fs_inode_t inode,
...
////////////////////////////////////////////////////////////////////////
fs_status_t
FsClass::write(fs_t *fs, fs_inode_t inode,
         void *buf, fs_size_t offset, fs_size_t length)
{
...
////////////////////////////////////////////////////////////////////////
fs_size_t
FsClass::size(fs_t *fs, fs_inode_t inode)
{
  cache_last_inode(fs, inode);
